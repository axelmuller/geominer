...
ont1 = pronto.Ontology('dummy_onto_2.obo')
ont2 = pronto.Ontology('dummy_onto_3.obo')

def test_obo2df():
    """unit test for creating a pandas dataframe from an ontology.
    the df has 3 columns, name of ontology, ontology id, and values""" 
